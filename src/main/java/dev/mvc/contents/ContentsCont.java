...
//    mav.setViewName("/contents/read"); // /webapp/contents/read.jsp
  ...
  /**
   * 등록폼 http://localhost:9090/resort/contents/img_create.do
   * 
   * @return
   */
  ...
  /**
   * 메인 이미지 등록 처리 http://localhost:9090/resort/contents/create.do
   * 
   * @return
   */
  ...
  /**
   * 등록폼 http://localhost:9090/resort/contents/img_update.do
   * 
   * @return
   */
